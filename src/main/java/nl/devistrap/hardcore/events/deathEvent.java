...
public class deathEvent implements Listener {
    ...
    public void onPlayerDeath(org.bukkit.event.entity.PlayerDeathEvent event) {
        if(!plugin.getConfig().getBoolean("settings.permanent-deathban")) {
            ...
            if (plugin.getConfig().getBoolean("discord-webhook.notify-on.automatic-deathban")) {
                DiscordWebhookNotifier.sendWebhookNotification("Player " + event.getEntity().getName() + " has been deathbanned", event.getEntity().getName(), false);
            }
            ...
            if (plugin.getConfig().getBoolean("discord-webhook.notify-on.automatic-deathban")) {
                DiscordWebhookNotifier.sendWebhookNotification("Player " + event.getEntity().getName() + " has been permanently deathbanned", event.getEntity().getName(), false);
            }
